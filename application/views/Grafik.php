    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {'title':'<?php echo $PieChartTitle; ?>',
                       'width':0 ,
                       'height':200,is3D: true,legend: { position: "center" }};
        ...
        //+1
        var PieChart= '<?php echo $PieChart;?>';
        var data = new google.visualization.DataTable();
        data.addColumn('string', 'Topping');
        data.addColumn('number', 'Slices');
        data.addRows(JSON.parse(PieChart));
        var optionss = {'title':'<?php echo $PieChartTitle11; ?>',
                       'width':0 ,
                       'height':200,is3D: true};

        // Instantiate and draw our chart, passing in some options.
        var chart = new google.visualization.PieChart(document.getElementById('chartt'));
        ...
        var data = new google.visualization.DataTable();
        data.addColumn('string', 'Topping');
        data.addColumn('number', 'Jumlah Penduduk');
        data.addColumn('number', 'Jumlah TKI');
        ...
        var data = new google.visualization.DataTable();
        data.addColumn('string', 'Topping');
        data.addColumn('number', 'Jumlah Penduduk Miskin');
        data.addColumn('number', 'Jumlah Penduduk');
